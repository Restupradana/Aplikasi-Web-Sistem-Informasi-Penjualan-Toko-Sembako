...
class KeuntunganController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($response->getStatusCode() == 200 && $data['status'] == true) {
            ...
            return view('keuntungan.index', ['transaksis' => [], 'error' => 'Failed to fetch data']);
        }
    }
    ...
    //     if ($data['status']) {
    //         return redirect()->route('keuntungan.index')->with('success', 'Transaction created successfully.');
    //     }
